...
import (
	"github.com/smartschool/config"
	//models "busmap.vn/bsmartcheckin/model/goadmin_setup/goadmin_models"
	"fmt"
	"os"
...
// func _autoMigrateSystemTables() {
// 	_ = DBInstance.AutoMigrate(
// 		&AuthIdentity{}, &asset_manager.AssetManager{}, &PortalLogging{}, &PortalUser{}, &PortalUserRole{},
// 	)
// }

func _autoMigrateCheckinTables() {
	// TODO: Migrate bCheckin table here
	DBInstance.AutoMigrate(&Student{})
}
